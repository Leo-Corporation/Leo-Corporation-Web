function generatePassword(length) {
    let chars = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ1234567890;:!/§ù*$%µ£)=+*-&é'(-è_ç<>?^¨";
    let pass = "";
...
})(300, function () { passwordTxt.innerHTML = generatePassword(randomNumber(13, 20)); });
...
const card = document.querySelector(darkThemeMq.matches ? ".treed-d" : ".treed");
const THRESHOLD = 4;
